...
import com.eveningoutpost.dexdrip.Services.ob1.ble.MAC2AdressFilter;
 ...
 * variants.
 */
public class MAC2AddressFilterTests {
    ...
    private MAC2AdressFilter colonFilter = new MAC2AdressFilter(MACAdressFilter.COLON);
    private MAC2AdressFilter dotFilter = new MAC2AdressFilter(MACAdressFilter.DOT);
    private MAC2AdressFilter hyphenFilter = new MAC2AdressFilter(MACAdressFilter.HYPHEN);
    private MAC2AdressFilter hyphenDotFilter = new MAC2AdressFilter(MACAdressFilter.HYPHEN,MACAdressFilter.DOT);
